...
public class Window extends JFrame implements KeyListener, MouseListener {
	...
	protected Audio[] soundEffects = new Audio[4];
	...
	public Window(String nom, ArrayList<Obstacles> obs, ArrayList<Projectile> prj) {
        ...
        try {
			...
			GUI[0] = ImageIO.read(new File("./Images/Coeur.png"));
			GUI[1] = ImageIO.read(new File("./Images/fire.png"));
        }
		 ...
		 * problème : g.drawImage entraine un rescale et ralenti donc fortement le programme
